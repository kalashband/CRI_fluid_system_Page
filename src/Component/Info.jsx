        ...
        <>
            <div className="info_container">
                <div className="trophy">
                    <img src={require('../Utils/1.png')} alt="trophy" />
                </div>
                <div className="achivement">
                    ...
                    <div className='photoContainer'><img src={require('../Utils/2.png')} alt="trophy" /></div>
                    <div className='lastContainer'><p>	Government of India has awarded the "National Energy Conservation Award 2018". Mr. G. Selvaraj, Joint Managing Director of C.R.I. Group received the award from Smt. Sumitra Mahajan, Speaker of Lok Sabha & Shri. Raj Kumar Singh, Honorable Minister of State.
                    </p></div>
                </div>
            </div>
        </>
